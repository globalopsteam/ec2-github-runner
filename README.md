...
| `runner-tar-file`                                                                                                                                                            | Optional. Used only with the `start` mode. | Specifies a pre-downloaded tar archive of actions-runner software that exists in the EC2 image.<br><br>                                                                                                                                                                                                                               |
| `reuse-runner`                                                                                                                                                               | Optional.                                  | Try to reuse an existing EC2 instance instead of creating another EC2 instances.<br><br>                                                                                                                                                                                                                                              |
| `runner-count`                                                                                                                                                               | Optional.                                  | Number of runner in one EC2 instance. Default to be 1.<br><br>                                                                                                                                                                                                                                                                        |
| `ssh-key-name`                                                                                                                                                               | Optional. Used only with the `start` mode. | SSH key pair ID.<br><br>                                                                                                                                                                                                                                                                                                              |
